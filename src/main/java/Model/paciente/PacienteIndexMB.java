...
public class PacienteIndexMB implements Serializable {
    ...
    public void preProcessPDF(Object document) throws IOException, BadElementException, DocumentException {
        ...
        String logo = externalContext.getRealPath("") + "resources"  + File.separator + "PLAT.png";
        ...
        try {
            if (raven){
                ...
                if(respuesta.equals("Este paciente tiene ya esta prueba asignada")){
                    ...
                    Notificacion.sendMessage(pacienteSelected.get("correo").toString());
                }
            }
    ...
    public String evaluar(JSONObject selected){
        ...
        try{
            ...
            GridFS bucket = new GridFS(db,"audio");
            System.out.println(intentoSelected);
            GridFSDBFile fileDB = bucket.findOne(new ObjectId(intentoSelected.get("cont_intento").toString()));

            file = new DefaultStreamedContent(fileDB.getInputStream(),fileDB.getContentType(),fileDB.getFilename());
    ...
    public String descargar(){
        ...
        try{
            ...
            DBCollection collection = db.getCollection("intento");
            GridFS bucket = new GridFS(db,"audio");
            GridFSDBFile fileDB = bucket.findOne(new ObjectId(intentoSelected.get("").toString()));
